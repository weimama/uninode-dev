    ...
    if (expression.callee.type === 'MemberExpression' &&
        ...
        if (expression.callee.property.name === 'Class') {
            ...
            if (expression.arguments.length === 2) {
                ...
                var factoryFunction = expression.arguments[1];
                if (factoryFunction.params && factoryFunction.params.length === 2) {
                    targetVarName = factoryFunction.params[1].name;
                }
...
function addDefineRequires(def) {
        ...
        for (var i=0; i<node.declarations.length; i++) {
            ...
            if (decl.init && decl.init.type === 'CallExpression') {
                ...
                if (callee.type === 'MemberExpression' && 
                    ...
                    def.moduleLoggerStatements.push(decl);
                }
            }
        }
    }
