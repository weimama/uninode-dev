...
function checkLang(n) {
    ...
    if (n.type === 'MemberExpression' && n.object && n.object.property && n.object
        ...
        if (n.property && n.property.name === 'language' && n.property.type === 'Identifier') {
            return true;
        }
    }
    return false;
    ...
    ast = estraverse.replace(ast, {
        ...
        leave: function(node, parent) {
            ...
            if (node && node.type === 'CallExpression' &&
                ...
                (node.callee.object && node.callee.object.type === 'Identifier' || node.callee.object && node.callee.object
                    .type === 'MemberExpression') &&
